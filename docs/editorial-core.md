...
16. **Alle artikler skal udvikles med ekstremt højt delingspotentiale som et selvstændigt redaktionelt mål.** Delbarhed skal tænkes ind allerede ved valg af historie og vinkel og derefter konsekvent i **hero, rubrik, manchet, `SAGEN KORT`, citater, tal, struktur og afslutning**. Målet er ikke clickbait, men at gøre den stærkeste dokumenterede pointe så tydelig, konkret og menneskelig, at læseren spontant får lyst til at sende artiklen videre.
   ...
   - **Lad dokumentationen bære konflikten – og brug citater til at give den liv:** når et stærkt officielt tal, dokument eller konkret resultat tydeligt viser historiens kerne, skal det som udgangspunkt prioriteres tidligt og bruges som hovedbevis. Følg meget gerne op med **stærke verificerede citater** fra især øjenvidner, berørte personer og centrale beslutningstagere, når de konkretiserer, forklarer eller menneskeliggør det, dokumentationen peger på. Et kort citat med karakter kan være mere delbart end flere afsnit med referat, og ved menneskelige konsekvenshistorier bør journalistens mål være flere konkrete stemmer frem for generiske parafraser. Citater skal styrke dokumentationen og historiens betydning, ikke erstatte den.

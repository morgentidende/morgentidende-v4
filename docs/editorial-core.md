...
13. **Forklar ukendte egenavne ved første omtale.** Første gang en person, organisation, virksomhed, institution, politisk bevægelse eller et parti nævnes, skal teksten kort forklare, hvem eller hvad det er, **når en almindelig dansk læser ikke med rimelighed kan forventes at kende navnet eller dets relevans i sagen**. Velkendte navne og steder behøver ikke kunstige forklaringer. Forklaringen skal være kort, naturlig og placeret tæt på første omtale, ikke encyklopædisk.
...
- Lav en **læserkontrol**: Kan en almindelig dansk læser forstå rubrik, `SAGEN KORT` og de første 2–3 afsnit uden forhåndskendskab til centrale personer, partier, virksomheder eller institutioner? Hvis ikke, tilføj korte naturlige forklaringer ved første relevante omtale.

...
- Personlige beretninger og øjenvidneartikler må ikke slutte med moraliserende, formanende eller belærende konklusioner, der fortæller læseren hvilke slutninger vedkommende bør eller ikke bør drage. Artiklen skal dokumentere citater, verificerbar kontekst og relevante modstridende fakta, når de er nødvendige for korrekthed; derefter skal læseren selv kunne vurdere materialet.
- Journalisten må gerne tydeliggøre, hvad der er dokumenteret, hvad der er personens egen fortolkning, og hvad der ikke kan verificeres. Denne kildekritik skal være konkret og nøgtern, ikke prædikende.
- På politiske emner skal Morgentidende som udgangspunkt være data-first: dokumentér relevante tal, primærkilder, citater, historik og væsentlige modstående oplysninger, og adskil klart dokumenterede fakta fra analyse og kommentar.
- Nyheds- og analyseartikler må ikke trække læseren mod en venstreorienteret, højreorienteret eller anden ideologisk eller moralsk konklusion gennem formanende sprog, selektiv framing eller afsluttende prædikener. Når de relevante fakta og kilder er fremlagt, skal læseren selv kunne drage sin konklusion.
- Redaktionen skal ikke skabe kunstig balance: veldokumenterede fakta skal ikke udvandes, og modargumenter skal kun medtages, når de er faktuelt eller journalistisk relevante. Neutralitet betyder nøgtern dokumentation, ikke falsk ækvivalens.
- Kommentarstof må fortsat have en tydelig holdning, men skal være markeret som Kommentar og holde vurderinger adskilt fra dokumenterede fakta.
